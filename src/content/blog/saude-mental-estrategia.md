...
faq:
  - q: "Saúde mental no trabalho é responsabilidade da empresa ou do colaborador?"
    a: "De ambos, mas com responsabilidades distintas. A empresa é responsável pelo ambiente: carga de trabalho, clareza de papéis, cultura psicologicamente segura e acesso a suporte. O colaborador é responsável por reconhecer seus limites e buscar ajuda. Quando a empresa coloca tudo no indivíduo, o discurso de bem-estar vira instrumento de culpabilização."
  - q: "Como implementar um programa de saúde mental sem que vire performance ou marketing?"
    a: "Começando pelo que é estrutural, não cosmético. Antes de apps de meditação e palestras, avalie: as lideranças têm tempo e condições para liderar bem? Há sobrecarga crônica? Existe segurança psicológica real para falar sobre dificuldades? Programas que não tocam nessas bases são bem-intencionados, mas superficiais."
  - q: "Quem cuida da saúde mental dos líderes dentro das empresas?"
    a: "Essa é exatamente a pergunta que a maioria das empresas não sabe responder. Líderes são preparados para apoiar seus times, mas raramente recebem o mesmo suporte. Conselhos, alta gestão e RH precisam criar mecanismos — fóruns seguros, mentoria, acompanhamento especializado — para que líderes também tenham espaço de vulnerabilidade."
  - q: "Quais sinais indicam que um líder está no limite do esgotamento?"
    a: "Os sinais mais comuns: irritabilidade crescente que antes não era padrão, isolamento progressivo de pares e equipe, decisões que fogem do padrão habitual, dificuldade de concentração em reuniões e a sensação persistente de que nada do que faz é suficiente. Esses sinais raramente aparecem isolados — e raramente são falsos alarmes."
---
