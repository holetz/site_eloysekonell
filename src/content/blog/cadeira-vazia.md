...
faq:
  - q: "Como evitar a cadeira vazia quando um líder-chave sai?"
    a: "A única forma de evitar a cadeira vazia é construir o banco de sucessores antes da crise. Isso exige um processo contínuo de identificação de potencial, desenvolvimento de competências e exposição progressiva a decisões estratégicas — não um plano guardado na gaveta."
  - q: "O que é assessment estratégico de liderança?"
    a: "Assessment estratégico de liderança é um processo estruturado de mapeamento de potencial, competências comportamentais e gaps de desenvolvimento. Vai além de testes pontuais: entrega uma visão sistêmica de quem está pronto para assumir posições críticas e o que cada pessoa precisa desenvolver."
  - q: "Qual o custo de substituir um executivo sem plano de sucessão?"
    a: "Substituir um executivo sem preparo custa em média 200% do salário anual, considerando recrutamento, curva de aprendizado, perda de conhecimento institucional e impacto na equipe. O custo invisível — instabilidade cultural e queda de produtividade — pode ser ainda maior."
  - q: "Com que antecedência iniciar o planejamento de sucessão?"
    a: "O planejamento de sucessão deve ser iniciado quando a organização ainda não precisa dele. O ideal é ter um pipeline de talentos em desenvolvimento permanente, revisado anualmente, de modo que a saída de qualquer líder-chave seja uma transição planejada, não uma emergência."
  - q: "Assessment e avaliação de desempenho são a mesma coisa?"
    a: "Não. Avaliação de desempenho mede resultados passados. Assessment de liderança mapeia potencial futuro: como a pessoa pensa, decide, lidera e se comporta sob pressão. São complementares, mas com objetivos distintos."
---
