...
- Usage: Reference from command with `@/home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/holetz/Projects/site_eloysekonell/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/holetz/Projects/site_eloysekonell/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
