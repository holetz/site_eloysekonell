...
- **Global scope**: `/home/holetz/Projects/site_eloysekonell/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/holetz/Projects/site_eloysekonell/.claude/notes/`)
...
2. Glob `/home/holetz/Projects/site_eloysekonell/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/holetz/Projects/site_eloysekonell/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/holetz/Projects/site_eloysekonell/.claude/notes/` — works in any directory
