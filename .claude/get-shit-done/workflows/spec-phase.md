...
```bash
INIT=$(node "/home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/templates/spec.md.
