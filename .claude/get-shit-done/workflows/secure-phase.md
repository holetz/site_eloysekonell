...
```
Agent(
  prompt="Read /home/holetz/Projects/site_eloysekonell/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/templates/SECURITY.md`
