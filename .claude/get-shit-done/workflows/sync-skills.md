...
INSTALL_JS_GLOBAL="/home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
