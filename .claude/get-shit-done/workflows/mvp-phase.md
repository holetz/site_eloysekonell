...
<required_reading>
@/home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/references/user-story-template.md
@/home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/references/spidr-splitting.md
@/home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/holetz/Projects/site_eloysekonell/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
